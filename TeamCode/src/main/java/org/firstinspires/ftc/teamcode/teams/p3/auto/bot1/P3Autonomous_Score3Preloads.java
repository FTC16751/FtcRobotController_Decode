...
@Autonomous(name="P3 AUTO: bot1 Score Preloads", group = "P3",preselectTeleOp = "P3: Teleop (Team Version)")
@Disabled
public class P3Autonomous_Score3Preloads extends OpMode {
    ...
    public void init_loop() {
        ...
        if (gamepad1.y) {
            location = CommonConstants.Location.CLOSE;
        }
        if (gamepad1.a) {
            location = CommonConstants.Location.FAR;
        }

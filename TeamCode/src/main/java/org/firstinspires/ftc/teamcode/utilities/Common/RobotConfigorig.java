...
public class RobotConfigorig {
     ...
     */
    public static RobotConfigorig createDefaultGearGirlsConfig() {
        return new RobotConfigorig(
                /* Motor Directions */
     ...
     */
    public static RobotConfigorig createDefaultP3Config() {
        return new RobotConfigorig(
                /* Motor Directions */
                DcMotorEx.Direction.REVERSE,  // Left Front
                DcMotorEx.Direction.FORWARD,  // Right Front
    ...
    public static RobotConfigorig createDefaultSkyLineConfig() {
        return new RobotConfigorig(
                /* Motor Directions */
     ...
     */
    public static RobotConfigorig createDefaultStandardBotConfig() {
            return new RobotConfigorig(
                    /* Motor Directions */
                    DcMotorEx.Direction.REVERSE,  // Left Front
                    DcMotorEx.Direction.FORWARD,  // Right Front

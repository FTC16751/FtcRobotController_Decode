...
public class SensorPinpointDriveToPoint extends LinearOpMode {
    ...
    static final Pose2D TARGET_2 = new Pose2D(DistanceUnit.INCH, -12, -12, AngleUnit.DEGREES, -90);
    ...
    static final Pose2D TARGET_5 = new Pose2D(DistanceUnit.INCH, 12, 0, AngleUnit.DEGREES, 0);
    ...
    public void runOpMode() {
        ...
        odo.setOffsets(-142.0, 120.0,DistanceUnit.INCH); //these are tuned for 3110-0002-0001 Product Insight #1

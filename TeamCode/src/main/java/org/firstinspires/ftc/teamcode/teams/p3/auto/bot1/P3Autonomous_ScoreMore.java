package org.firstinspires.ftc.teamcode.teams.p3.auto.bot1;
...
import org.firstinspires.ftc.teamcode.teams.p3.P3_Robot_Bot1;
//import org.firstinspires.ftc.teamcode.common.SharedState;

@Autonomous(name="P3 AUTO: bot1 Score Preloads + 3", group = "P3",preselectTeleOp = "P3: Teleop (Team Version)")
@Disabled
public class P3Autonomous_ScoreMore extends OpMode {
    ...
    private enum RedFarState { START, MOVE_AWAY_FROM_GOAL, START_SHOOTING, SHOOTING, MOVE_TO_SPIKE_MARK1, INTAKE_ARTIFACTS_FROM_SPIKEMARK1, DRIVE_TO_SCORE_LINE, START_SHOOTING2, SHOOTING2, PARK }
        ...
        switch (redFarState) {
            ...
            case SHOOTING:
                ...
                if (shotsFired < 3) {
                    ...
                    // All 3 shots are done, move to the next auto state (e.g., PARK).
                    redFarState = RedFarState.MOVE_TO_SPIKE_MARK1;
                }
                //}
                break;
            case MOVE_TO_SPIKE_MARK1:
            ...
            case SHOOTING2:
                ...
                break;
            case PARK:
                if (robot.drive.driveTo(robot.drive.pinpoint.getPosition(), P3RobotConstants.Waypoints.RED_FAR_PARK_POSITION, 0.3, .25)) {
                    autonomousState = AutonomousState.COMPLETE;
                }
                break;
        }

...
import org.firstinspires.ftc.teamcode.utilities.GBP2P.DriveToPoint;
...
public class SensorPinpointDriveToPoint extends LinearOpMode {
    ...
    static final Pose2D TARGET_1 = new Pose2D(DistanceUnit.INCH,-26,36,AngleUnit.DEGREES,-54);
    static final Pose2D TARGET_2 = new Pose2D(DistanceUnit.INCH, -34, 24, AngleUnit.DEGREES, 90);
    static final Pose2D TARGET_3 = new Pose2D(DistanceUnit.INCH,0,-0, AngleUnit.DEGREES,0);
    ...
    public void runOpMode() {
        ...
        odo.setOffsets(-38.0, 165.0,DistanceUnit.MM); //these are tuned for 3110-0002-0001 Product Insight #1
        ...
        while (opModeIsActive()) {
            ...
            switch (stateMachine){
                ...
                case DRIVE_TO_TARGET_1:
                     ...
                     */
                    if (nav.driveTo(odo.getPosition(), TARGET_1, 0.4, 2)){
                ...
                case DRIVE_TO_TARGET_4:
                    if(nav.driveTo(odo.getPosition(),TARGET_4,0.4,1)){

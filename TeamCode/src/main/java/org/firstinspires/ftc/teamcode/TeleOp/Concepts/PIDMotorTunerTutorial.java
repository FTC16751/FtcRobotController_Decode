...
public class PIDMotorTunerTutorial extends OpMode {
    ...
    double F = 1; // Feedforward gain to counteract constant forces like friction.
    double P = 1;    // Proportional gain to correct error based on how far off the velocity is.
    ...
    @Override
    public void init() {
        flywheelMotor_l = hardwareMap.get(DcMotorEx.class, "turret_motor");
